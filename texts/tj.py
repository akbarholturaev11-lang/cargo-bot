...
PHONE_NOT_FOUND = (
    "❌ Ин рақам дар база ёфт нашуд.\n"
    "Лутфан рақамро дуруст ворид кунед ё аввал сабти ном кунед."
)
NAME_MISMATCH = (
    "❌ Ному насаб мувофиқат накард.\n"
...
WAREHOUSE_ADDRESS_MISSING = (
    "❌ Адреси ин склад ҳоло дар база илова нашудааст.\n"
